...
app.get('/api/protected/random-quote', quote.random);
app.get('/api/users', roles.find);
...
// Create our HTTPS server listening on port 8002.
https.createServer(options, app).listen(8002);
console.log("OAuth 2.0 Authorization Server started on port 8002");
